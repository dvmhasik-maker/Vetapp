  ...
  return (
    <div className="poisoning-guide-content">
      ...
      <GuideFAQ
        items={[
          {
            q: '집에서 과산화수소로 구토를 유발해도 되나요?',
            a: '가정에서의 자가 구토 유발은 흡인성 폐렴, 식도 손상 등 위험이 크고 물질에 따라 금기인 경우도 많아 권장하지 않습니다. 반드시 병원 내원 또는 수의사·동물 중독센터 상담 후 진행해야 합니다.',
          },
          {
            q: '섭취 후 몇 시간이 지났는데 지금 데려가도 의미가 있나요?',
            a: '구토 유발의 효과는 시간이 지날수록 떨어지지만, 물질에 따라 증상이 지연 발현되는 경우(예: 포도/건포도의 신부전, 항응고제 살서제의 출혈)가 많아 시간이 경과했더라도 즉시 내원해 혈액 검사 및 모니터링을 받는 것이 중요합니다.',
          },
          {
            q: '어떤 정보를 챙겨서 병원에 가야 빠른 처치에 도움이 되나요?',
            a: '섭취한 물질의 포장지·성분표, 추정 섭취량과 섭취 시각, 체중을 함께 지참하면 진단과 처치 속도를 크게 높일 수 있습니다. 가능하다면 토사물이나 남은 물질 샘플도 함께 가져가는 것이 좋습니다.',
          },
        ]}
      />
